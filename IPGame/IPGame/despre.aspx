<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="despre.aspx.vb" Inherits="IPGame.Despre" %>
  ...
  <div id="parteaDeSus">
   <div id="meniuContainer">
    <ul class='meniu' rel="sam1">
      ...
      <li class="activ"><a href="despre.aspx">Despre joc</a></li>
    </ul>
   </div> <!-- / meniuContainer -->
 ...
 <!-- user logat -->
  ...
  <div id="parteaStanga">
       <div class="primaPagina">
          <h1 class='titluStanga'>Razboiul Robotilor - Despre joc</h1>
          <p>Joc de tip player vs player denumit <strong>Razboiul Robotilor</strong>.<br />
          Descriere bla bla</p>
