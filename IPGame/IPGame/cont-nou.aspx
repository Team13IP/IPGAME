<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cont-nou.aspx.vb" Inherits="IPGame.cont_nou" %>
<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='ro' lang='ro'>
<head>
<title>Razboiul Robotilor - Echipa 13 - Despre Joc</title>
 ...
 <!-- user logat -->
  ...
  <div id="parteaStanga">
       <div class="primaPagina">
          <h1 class='titluStanga'>Înregistrare User Nou</h1>
         
        <div class="istoric"> 
          <div class="puncte"> 
           <li class=jucator>
          <span class="statisticaSus" style="height:16px;width:118px;">Username</span>
          <asp:TextBox ID="uname" runat="server" CssClass="statisticaSus" Height="16px" 
                  Width="118px"></asp:TextBox></li> 
          <li class=jucator><span class="statisticaSus" style="height:16px;width:118px;">Password&nbsp; </span>
          <asp:TextBox ID="pword" runat="server" CssClass="statisticaSus" Height="16px" 
                  Width="118px" TextMode="Password"></asp:TextBox></li> 
          <li class=jucator><span class="statisticaSus" style="height:16px;width:118px;">Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <asp:TextBox ID="mail" runat="server" CssClass="statisticaSus" Height="16px" Width="118px"></asp:TextBox></li> 
          <li class="jucator"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          <asp:Button ID="Button2" runat="server" CssClass="tipLupta" Text="Înregistreaza" />
             
      </li> <ul style="margin-left: 80px">
                  <br />
