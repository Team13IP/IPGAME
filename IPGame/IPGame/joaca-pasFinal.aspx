<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="joaca-pasFinal.aspx.vb" Inherits="IPGame.WebForm5" %>
 ...
 <!-- user logat -->
  ...
  <div id="parteaStanga">
       <div class="primaPagina">
          ...
          <h3>Lupta a inceput!&nbsp;&nbsp; </h3>
           <h3>Ai 2 minute pentru ati alege miscarea!</h3>
            <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                Runda
         ...
         <div class="lupta">
            ...
            <div class="player1">
                <asp:Image ID="Image1" ImageUrl="imagini/roboton.png" CssClass="robotSt" runat="server" />
              <div class="informatiiUserLupta">
                <span>User </span>
            ...
            <div class="player2">
             <asp:Image ID="Image2" ImageUrl="imagini/robotix.png" CssClass="robotDr" runat="server" />
              <div class="informatiiUserLupta">
          <span>User </span>
                  <asp:Label ID="Label5" runat="server" ForeColor="white" Text="Label"></asp:Label> <br />
                <span>Robot </span> 
                  <asp:Label ID="Label6" runat="server" ForeColor="white" Text="Label"></asp:Label><br />
                <span>Rank </span>
                  <asp:Label ID="Label7" runat="server" ForeColor=white Text="Label"></asp:Label><br />
                <span>HP </span> 
         ...
         <div class="butoaneLupta">
              <div class="butoane1">
                  <asp:Label ID="Label9" runat="server" Text=" "></asp:Label>
              </div>
              <div class="butoane1">
                  <asp:Button ID="Button2" CssClass="actiune1" runat="server" Text="Rachete" 
                      Visible="False" />
                    <asp:Button ID="Button3" CssClass="actiune1" runat="server" Text="Laser" 
                      Visible="False" />
             <asp:Button ID="Button4" CssClass="actiune1" runat="server" Text="Melee" 
                      Visible="False" />
       
                
              </div>
               <div class="butoaneLupta">
                     <asp:TextBox ID="TextBox1" runat="server" Enabled="False" TextMode="MultiLine" Height="125px" Width="425px" CssClass="actiune1"></asp:TextBox>
...
<asp:Label ID="Cmen41" runat="server" cssclass="nr" Text="Label">4.</asp:Label>
 ...
 <asp:Label ID="Cmen101" runat="server" cssclass="nr" Text="Label">10.</asp:Label>
       ...
       <asp:Timer ID="Timer2" runat="server" Enabled="False" Interval="10000">
       </asp:Timer>
