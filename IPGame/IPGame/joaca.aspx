<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="joaca.aspx.vb" Inherits="IPGame.WebForm3" %>
 ...
 <span class="statisticaSus">Loc ocupat in clasament: </span> 1<br />
  ...
  <div id="parteaStanga">
       <div class="primaPagina">
          ...
          <h3>Alege-ti Robotul cu care vrei sa intri in lupta!</h3>
          <div id="selectRobot">
            <asp:RadioButton ID="RadioButton1" CssClass="robot"  runat="server" />
            <asp:Image ID="Image1"  imageurl="imagini/robotix.png" runat="server" />
            <p class='par-dreapta'>Robotix are urmatoarele caracteristici:<br />
              Rachete: 
            ...
            <asp:RadioButton ID="RadioButton2" CssClass="robot"  runat="server" />
                <asp:Image ID="Image2"  imageurl="imagini/roboton.png" runat="server" />
            <p class='par-dreapta'>Roboton are urmatoarele caracteristici:<br />
              Rachete: 
            ...
            <asp:RadioButton ID="RadioButton3" CssClass="robot"  runat="server" />
                <asp:Image ID="Image3"  imageurl="imagini/agrobot.png" runat="server" />
              <p class='par-dreapta'>Agrobot are urmatoarele caracteristici:<br />
              Rachete: 
         ...
         <div class="amAles">
         <asp:Button ID="Button2" CssClass="alegeRobot" runat="server" Text="Am ales Robotul" />
         </div>
