...
Public Class cont_nou
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button2.Click
        Dim s As New Service1Client
        Dim s1 As UserNouRequest
        Dim s2 As UserNouResponse
        If uname.Text = "" Or pword.Text = "" Or mail.Text = "" Then
            Label1.Text = "Unul din campuri este gol, reincercati"
            Label1.Visible = True
        Else

            s1 = New UserNouRequest(uname.Text, pword.Text, mail.Text)
            s2 = s.UserNou(s1)
            If s2.UserNouResult > 0 Then

                Label1.Text = "V-ati creat cu succes un cont, in curand va veti putea autentifica"
                Label1.Visible = True
            Else
                Label1.Text = "Eroare la crearea contului, username exista deja, reincercati"
                Label1.Visible = True
